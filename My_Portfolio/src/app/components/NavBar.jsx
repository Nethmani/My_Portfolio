...
export default function NavBar() {
  ...
  const isActive = (path) => {
    return pathname === path
      ? "text-blue-400 font-semibold relative after:absolute after:bottom-0 after:left-0 after:w-full after:h-0.5 after:bg-blue-400 after:rounded-full"
      : "hover:text-blue-400 transition-all duration-300 hover:scale-105";
  };
  ...
  return (
    ...
    >
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex-shrink-0">
            <Link href="/" className="flex items-center space-x-2 group">
              <div className="w-10 h-10 bg-gradient-to-br from-blue-500 to-purple-600 rounded-lg flex items-center justify-center shadow-lg group-hover:shadow-blue-500/25 transition-all duration-300">
          ...
          <div className="md:hidden">
            <button
              ...
              className="p-2 text-gray-400 hover:text-white transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 rounded-lg"
      ...
      >
        <div className="bg-gray-900/95 backdrop-blur-md border-t border-gray-800 px-4 py-4 space-y-2">
          {[
            { href: "/", label: "Home" },
            { href: "/about", label: "About" },
            { href: "/education", label: "Education" },
