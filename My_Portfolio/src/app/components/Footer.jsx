        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="flex space-x-4 mt-6">
              {socialLinks.map((link) => (
                <a
                  ...
                  className="p-2 text-gray-400 hover:text-white transition-all duration-300 hover:bg-gray-700 rounded-lg group"
          ...
          <div>
            ...
            <div className="space-y-2">
              ...
              <Link
                href="/contact"
                className="inline-flex items-center space-x-2 text-blue-400 hover:text-blue-300 transition-colors duration-300 text-sm font-medium"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
            <div className="text-gray-400 text-sm">
              © {currentYear} Pamalka Nethmani. All rights reserved.
            </div>
